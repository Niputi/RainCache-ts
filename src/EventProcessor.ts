...
class EventProcessor extends EventEmitter {
    ...
    options: { cache: { guild: GuildCache; channel: ChannelCache; member: MemberCache; role: RoleCache; user: UserCache; emoji: EmojiCache; channelMap: ChannelMapCache; presence: PresenceCache; }; presenceInterval: number | undefined; disabledEvents: any };
     ...
     * @param options
     */
    constructor(options?: {cache: { guild: GuildCache, channel: ChannelCache, member: MemberCache, role: RoleCache, user: UserCache, emoji: EmojiCache, channelMap: ChannelMapCache, presence: PresenceCache}, presenceInterval? : undefined | number, disabledEvents: any}) {
        super();
    ...
    handlePresenceUpdate(presenceEvent: any) {
    ...
    async processReady(readyEvent: any) {
        let updates = [];
    ...
    async onChannelCreate(channelCreateEvent: any) {
    ...
    async onChannelDelete(channelDeleteEvent: any) {
