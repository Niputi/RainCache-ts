...
class PresenceCache extends BaseCache {
     ...
     */
    constructor(storageEngine : BaseStorageEngine, userCache : UserCache, boundObject) {
        super();
     ...
     */
    async get(id: string) : Promise<PresenceCache | null|  Object> {
        if (this.boundObject) {
     ...
     */
    async update(id: string, data): Promise<PresenceCache> {
        if (this.boundObject) {
